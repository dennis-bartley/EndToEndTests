    ...
    def test2_OpenFOAMCaseRunner(self):
        ...
        for div in links:
            try:
                ...
                if ("openfoam_runner" in title and "multicase" not in title):
                    openfoam=div
            except Exception, e:
                print "Exception", e
        ...
        try:
            ...
            selector.select_by_visible_text("1: motorBike.tgz")
        except Exception, e:
            print e
        ...
        try:
            ...
            self.fail("Can't find UID-7")
            
        try:
            selectElement = caseInputFile.find_element_by_tag_name("select")
            selector = Select(selectElement)
            selector.select_by_visible_text("9: decomposeParDict")
        except Exception, e:
            print e
            self.fail("can,t find the select list ")
